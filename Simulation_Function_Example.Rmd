...
for the simulation (nrep). The function uses a uniform censoring pattern from 0 to week 8 (see C1 in line 102). 
...
A user can toggle the code to use these patterns in lines 104 and 106.
